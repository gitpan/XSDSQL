package blx::xsdsql::generator::sql::oracle::handle::create_sequence;
use strict;
use warnings;
use Carp;
...
blx::xsdsql::generator::sql::oracle::handle::create_sequence  - create_sequence  for postgres


=head1 SYNOPSIS


use blx::xsdsql::generator::sql::oracle::handle::create_sequence

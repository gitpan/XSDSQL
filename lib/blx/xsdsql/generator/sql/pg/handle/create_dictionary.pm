package blx::xsdsql::generator::sql::pg::handle::create_dictionary;
use strict;
use warnings;
use Carp;
...
blx::xsdsql::generator::sql::pg::handle::create_dictionary  - create table dictionary  for postgres


=head1 SYNOPSIS


use blx::xsdsql::generator::sql::pg::handle::create_dictionary
